...
public class WeatherDataProvider {
     ...
     */
    public  HashMap<String, String> getWeatherData(String cityName) throws Exception {
        ...
        if(coordinate!=null){
            ...
            throw new Exception("No results found for "+cityName);
        }
    }
    ...
    private String getAPIURL(String latitude, String longitude){
        return "https://api.darksky.net/forecast/1a43d545710c14571dbbe87b13bad8c7/"+ latitude +","+ longitude+"?exclude=[minutely,alerts,flags]";
    }
